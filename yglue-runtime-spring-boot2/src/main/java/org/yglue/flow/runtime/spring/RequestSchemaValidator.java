 ...
 * Spring Boot 2 版本（使用 javax.servlet）。
 */
class RequestSchemaValidator {
    ...
    RequestSchemaValidator.ValidationResult validate(RestEntryPoint entryPoint,
                                                     HttpServletRequest request,
                                                     Map<String, Object> payload) {
        JsonNode schemaNode = resolveSchema(entryPoint);
        if (schemaNode == null || schemaNode.isMissingNode()) {
            return RequestSchemaValidator.ValidationResult.success(null);
        }
        ...
        if (!errors.isEmpty()) {
            return RequestSchemaValidator.ValidationResult.failure(errors);
        }
        return RequestSchemaValidator.ValidationResult.success(normalized);
    }
    ...
    static class ValidationResult {
        ...
        static ValidationResult success(Map<String, Object> normalized) {
            return new ValidationResult(true, normalized, Collections.emptyList());
        }

        static ValidationResult failure(List<FieldError> errors) {
            return new ValidationResult(false, null, Collections.unmodifiableList(errors));
        }
    ...
    private static class ValidationContext {
        ...
        Map<String, Object> pathMap() {
            ...
            return cachedPath == null ? Collections.emptyMap() : cachedPath;
        }
        ...
        Map<String, Object> queryMap() {
            ...
            return cachedQuery == null ? Collections.emptyMap() : cachedQuery;
        }
        ...
        Map<String, Object> headersMap() {
            ...
            if (rawMap == null) {
                cachedHeaders = Collections.emptyMap();
                return cachedHeaders;
            }
