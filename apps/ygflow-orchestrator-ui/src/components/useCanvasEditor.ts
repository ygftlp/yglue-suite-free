...
export function useCanvasEditor(props: CanvasEditorProps) {
  ...
  return {
    ...
    flowPrecheckIssues: flowIO.flowPrecheckIssues,
    flowPrecheckSummary: flowIO.flowPrecheckSummary,
    flowPrecheckBlocking: flowIO.flowPrecheckBlocking,
    flowPrecheckHighlights: flowIO.flowPrecheckHighlights,
    flowPrecheckMessage: flowIO.flowPrecheckMessage,
